...
// sehirlerin bagli listesinin baslangici
Sehir *sehirListesi = NULL;

// Hash tablosunun baslangici
HashTablo *bayiHashTablosu = NULL;

// ikisi de en basta NULL yani bos olarak kabul edilir
...
// Hash tablosuna bayi ekleme kısmı
...
// Hash tablosundan bayi arama kısmı
...
// Yeni bir motor dugumu olusturma kısmı
...
// Yeni bir bayi dugumu olusturma kısmı
...
// Yeni bir sehir dugumu olusutrma kısmı
...
void sehreBayiEkle(char *sehirAdi, char *bayiAdi)
{
    ...
    // sehir olup olmadıgını kontrol eder
...
int main()
{
    ...
    sehreBayiEkle("Izmir", "Izmir Bayi");
    sehreBayiEkle("Bursa", "Bursa Bayi");
    sehreBayiEkle("Ankara", "Ankara Bayi");
    sehreBayiEkle("Istanbul", "Istanbul Bayi");
    sehreBayiEkle("Istanbul", "Kadikoy Bayi");

    bayiyeMotorEkle("Izmir Bayi", "Yamaha RayZR", "RayZR", 4);
    bayiyeMotorEkle("Izmir Bayi", "Yamaha D'elight", "D'elight", 2);
    ...
    bayiyeMotorEkle("Bursa Bayi", "Yamaha MT-09 IV. NES�L", "MT-09 IV. NES�L", 2);
    bayiyeMotorEkle("Bursa Bayi", "Yamaha MT-10", "MT-10", 1);
    ...
    bayiyeMotorEkle("Bursa Bayi", "Yamaha XSR700 XTribute", "XSR700 XTribute", 2);
    bayiyeMotorEkle("Kadikoy Bayi", "Yamaha XSR900 GP", "XSR900 GP", 1);

    // Adventure
    bayiyeMotorEkle("Ankara Bayi", "Yamaha Tanaro 700", "Tanaro 700", 4);
    bayiyeMotorEkle("Istanbul Bayi", "Yamaha Tanaro 700 World Raid", "Tanaro 700 World Raid", 3);
